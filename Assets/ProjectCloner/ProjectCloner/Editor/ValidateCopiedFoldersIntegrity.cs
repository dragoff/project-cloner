    ...
    public class ValidateCopiedFoldersIntegrity
    {
        ...
        static ValidateCopiedFoldersIntegrity()
        {
            if (!SessionState.GetBool(SessionStateKey, false))
            {
                ...
                if (!Helper.IsClone()) { return; }

                ValidateFolder(Helper.GetCurrentProjectPath(), Helper.GetOriginalProjectPath(), "Packages");
            }
        }
        ...
        public static void ValidateFolder(string targetRoot, string originalRoot, string folderName)
        {
            ...
            {
                Debug.Log("ProjectCloner: Detected changes in '" + folderName + "' directory. Updating cloned project...");
